...
export default function InventarioHome() {
    ...
    const ModuleCard = ({ module }) => {
        ...
        return (
            <Link
                to={module.path}
                className="block p-3 sm:p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1 text-center border border-gray-100 h-full flex flex-col items-center justify-center"
            >
                <div className={`w-12 h-12 ${module.color.replace('600', '50').replace('500', '50').replace('700', '50')} rounded-full flex items-center justify-center mb-2`}>
                    <Icon className={`w-6 h-6 ${module.color.replace('bg-', 'text-')}`} />
                </div>
                <h3 className="text-base font-medium text-gray-800 mb-0.5 leading-tight">
                    {module.title}
                </h3>
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-3 sm:p-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-6 max-w-5xl mx-auto mb-4 sm:mb-8">
                ...
                <div className="max-w-5xl mx-auto mb-4 sm:mb-8">
                    <div className="bg-white rounded-2xl p-3 sm:p-6 shadow-sm border border-gray-100">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-4 gap-2 sm:gap-4 justify-center max-w-2xl mx-auto">
                ...
                <div className="max-w-5xl mx-auto bg-white rounded-2xl p-3 sm:p-6 shadow-sm border border-gray-100">
                    <h2 className="text-center text-sm font-semibold text-gray-500 uppercase tracking-wider mb-3 sm:mb-6">
                        Gestión Comercial
                    </h2>
